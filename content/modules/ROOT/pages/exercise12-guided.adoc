...
metadata:
  annotations:
    k8s.v1.cni.cncf.io/policy-for: namespace-user5/exercise12-nad
  creationTimestamp: "2024-12-15T01:30:33Z"
  generation: 1
  name: allow-80-on-exercise12
  namespace: namespace-user5
  resourceVersion: "545792"
  uid: 61ac0573-7afc-4937-b3db-17b549335022
spec:
  ingress:
  - from:
    - podSelector:
