...
[start=6]
6. On left side menu, click on `Networking` -> `NetworkPolicies` -> `MultiNetworkPolicies`
...
[start=8]
8. On left side menu, click on `Networking` -> `NetworkPolicies` -> `MultiNetworkPolicies` and click on `allow-80-on-exercise12`
